...
const getTileAmount = async (tokenId, collectionId) => {
    ...
    if (!collection[tokenId]) {
        if (collectionId ===
            ...
            collectionId ===
                'SP27F9EJH20K3GT6GHZG0RD08REZKY2TDMD6D9M2Z.btc-badgers-v2') {
            const data = Object.assign(Object.assign({}, collection), { [tokenId]: { amount: 12, checked: false } });
            await redis_1.default.hSet('3:COLLECTION', collectionId, JSON.stringify(data));
            return 12;
        }
        // save the new token id to that collection
        const data = Object.assign(Object.assign({}, collection), { [tokenId]: { amount: 6, checked: false } });
        await redis_1.default.hSet('3:COLLECTION', collectionId, JSON.stringify(data));
        return 6;
    }
    // get amount from NFT
